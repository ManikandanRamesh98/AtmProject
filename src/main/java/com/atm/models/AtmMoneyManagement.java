...
public class AtmMoneyManagement {
	private int id;
	...
	public AtmMoneyManagement(int id, Long moneydeposited, Long moneybalance, String depositedat, String agentname) {
	...
	public AtmMoneyManagement(Long moneydeposited, String agentname) {

		this.moneydeposited = moneydeposited;
		this.agentname = agentname;
	}
	
	public AtmMoneyManagement(Long moneybalance) {
