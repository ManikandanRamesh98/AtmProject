...
public Userprofilepojo(int id, String username, Long user_acc_no, int balance, Long mob_no, int user_pin,
...
public Userprofilepojo(String username,int balance) {

	this.username = username;
	this.balance = balance;
}

public Userprofilepojo(String username) {

	this.username = username;
}

public Userprofilepojo(String username, Long user_acc_no, Long mob_no, int user_pin) {
...
public Userprofilepojo(Long acc_no) {

	this.user_acc_no = acc_no;
}
public Userprofilepojo(String username, Long user_acc_no) {
